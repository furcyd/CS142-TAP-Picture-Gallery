...
public class P3D7 extends Application
{
    ...
    /*This filter takes the image labeled "before1.jpg" or "before1.png" and applies a 3D
    effect. The filter takes the Red RGB integer value and shifts it to the left 10 pixels first, then
    takes the Blue RGB integer value and shifts it to the right 10 pixels.*/
    public static void coolEffect()
    {
        ...
        for (int c = 20; c < before1.getWidth(); c++) {
            for (int r = 0; r < before1.getHeight(); r++) {
                before1.setRed(before1.getRed(c+10,r), c-10 , r);
                
            }
        }
        for (int c=20; c < before1.getWidth();c++){
            for(int r=0;r < before1.getHeight();r++){
                before1.setBlue(before1.getBlue(c-10,r), c+10 , r);
            }
        }
    ...
    private static int width = 1140;   // update this line as needed
    private static int height = 640;  // update this line as needed
    ...
    private static void reloadOriginalImage() {
        before1.loadPicture("./pics/before1.jpg", width, height);
    }
    ...
    private static void performAction(int actionNumber)
    {
        switch (actionNumber) 
        {
            ...
            case 2: reloadOriginalImage(); break;
        }
