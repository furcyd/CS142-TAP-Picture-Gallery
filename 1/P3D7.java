...
public class P3D7 extends Application
{
    ...
    public static void coolEffect()
    {
        ...
        for( int r = 0; r < before1.getHeight(); r++)
            for( int c = 0; c < before2.getWidth(); c++)
            {
                before1.setRed( (before1.getRed(r,c) + before2.getRed(r,c))/2, r , c);
                before1.setGreen( (before1.getGreen(r,c) + before2.getGreen(r,c))/2, r , c);
                before1.setBlue( (before1.getBlue(r,c) + before2.getBlue(r,c))/2, r , c);
            }
