...
public class P3D7 extends Application
{
    ...
    //  First, I created a for statement with the local variable int.
     // Inside of the second block I created a local variable that gets
    // the value of green in every pixel. I took the green variable and
       // subtracted 255 by it to invert the picture. Finally, I took the
       // picture of the green and set it to reverse green.
    public static void coolEffect()
    {
        ...
        for (int r = 0; r < before1.getHeight(); r++)
        {
            ...
            {
                int Green = before1.getRed(c,r);
                int ReverseGreen = 255 - Green;
                before1.setGreen(ReverseGreen,c,r);
