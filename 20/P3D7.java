...
public class P3D7 extends Application
{
    ...
    /*My code applies a colorblind filter by removing the red and replacing 
      it with the average of blue and green, so this is close to what a 
      colorblind person would see and I chose th efall foliage to show a 
      dramatic effect
      */
    public static void coolEffect()
    {
        ...
        for(int c = 0; c < before1.getWidth (); c++)
        {
            ...
            {
                before1.setRed((before1.getBlue(c,r)+before1.getGreen(c,r))/2,c, r);
            }
        }
