...
public class P3D7 extends Application
{
    ...
    /* My code is composed of a mirroring effect as well as high definition and
    sharpness, low levels of tint and warmth, high levels of vibrance and
    saturation. I aimed to make my filter look like similar to hippie
    vibes. In fact, I was inspired by the photo app Retrica.
     */
    public static void coolEffect()
    {
        ...
        for(int c = 0; c < before1.getWidth() / 2; c++)
        {
            for(int r = 0; r < before1.getHeight(); r++)
            {
                ...
                before1.setGreen(before1.getGreen(c,r), before1.getWidth() - 1 - c, r);
                before1.setBlue(before1.getBlue(c,r), before1.getWidth() - 1 - c, r);
            }
        }
    ...
    private static int width = 400;   // update this line as needed
    private static int height = 400;  // update this line as needed
