...
public class P3D7 extends Application
{
    ...
    public static void coolEffect()
    {
        ...
        for (int c = 0; c < before1.getWidth(); c++) {
            for (int r = 0; r < before1.getHeight(); r++) {
                int red = before1.getRed(c,r);
                int green = before1.getGreen(c,r);
                int blue = before1.getGreen(c,r);
                before1.setRed(blue ,c ,r); 
                before1.setGreen(red ,c ,r);
                before1.setBlue(green ,c ,r);
            }
        }
    ...
    private static int height = 888;  // update this line as needed
